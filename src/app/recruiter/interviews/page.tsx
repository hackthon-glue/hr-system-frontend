  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <main className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        {/* Page Title */}
        <div className="mb-10">
          <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent mb-3">Interview Management</h1>
          <p className="text-gray-600 text-lg">Review interview status and evaluation results</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          ...
          <div className="group relative overflow-hidden bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 border border-red-100/50 hover:border-red-200 hover:-translate-y-1">
            ...
            <div className="relative flex items-center gap-4">
              ...
              <div>
                <p className="text-sm font-medium text-gray-600">不Passed</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              >
                ...
                <option value="failed">不Passed</option>
        ...
        <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200/50 overflow-hidden">
          <div className="px-6 py-5 border-b border-gray-200/50 bg-gradient-to-r from-gray-50/80 to-white/80">
            <h2 className="text-xl font-bold text-gray-900">Interviews List ({filteredInterviews.length}items)</h2>
          </div>
          {filteredInterviews.length > 0 ? (
                      ...
                      <div className="flex items-center gap-4 mb-3">
                        ...
                        <div className="flex-1">
                          <h3 className="font-bold text-gray-900 mb-1 group-hover:text-purple-600 transition-colors">
                            {getInterviewTypeLabel(interview.interview_type)} - Round {interview.round_number}
                          </h3>
                          <p className="text-sm text-gray-600 font-medium">Interview ID: {interview.id}</p>
                        </div>
                      </div>
            ...
            <div className="px-6 py-20 text-center">
              ...
              <p className="text-xl font-bold text-gray-700 mb-2">No matching interviews found</p>
              <p className="text-gray-600">フィルター条itemsを変更してください</p>
            </div>
          )}
        </div>
      </main>
